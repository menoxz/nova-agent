...
- `nova://mcp/transport-readiness` documents the metadata-only readiness policy for a possible future HTTP/streamable transport while keeping stdio as the only active transport.
