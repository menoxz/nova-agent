...
export const readOnlySafetyMatrix: readonly SafetyMatrixEntry[] = [
  ...
  safeCli('cli.production.readiness', 'nova production readiness | nova production doctor', 'Builds offline/static production and install readiness diagnostics without provider calls, secret reads, tools, network, publish, tag, or daemon.', ['src/index.ts', 'src/production/readiness.ts', 'src/production/smoke.ts']),
  entry({
...
export const packageScriptCoverage: readonly PackageScriptCoverage[] = [
  ...
  { script: 'tui:opentui-smoke', matrixId: 'script.smokes.safe', coverage: 'exact', rationale: 'offline OpenTUI vertical slice smoke via Bun test renderer; no provider call.' },
  ...
  { script: 'production:smoke', matrixId: 'script.smokes.safe', coverage: 'exact', rationale: 'offline static production/install readiness smoke without env, network, provider calls, publish, tag, or daemon.' },
  ...
  { script: 'eval:production', matrixId: 'script.eval-mock', coverage: 'exact', rationale: 'explicit mock production readiness eval suite.' },
