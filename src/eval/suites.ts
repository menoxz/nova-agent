...
export const evalSuites = {
  ...
  lsp: ['lsp-readonly-metadata', 'lsp-v1-1-client-setup-policy', 'lsp-v1-1-policy-metadata-helper-smoke', 'lsp-v1-1-telemetry-summary-policy', 'lsp-v1-1-source-derived-metadata'],
