...
export const providerProfiles: ProviderProfile[] = [
  ...
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode model priority: gpt-5 is treated as a preferred default-class model.',
  },
  {
    id: 'openrouter-openai-gpt-5-mini',
    label: 'OpenRouter · OpenAI GPT-5 mini',
    provider: 'openrouter',
    baseUrl: 'https://openrouter.ai/api/v1',
    model: 'openai/gpt-5-mini',
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode small-model priority for fast/low-cost runs.',
  },
  {
    id: 'openrouter-openai-gpt-5-chat',
    label: 'OpenRouter · OpenAI GPT-5 chat',
    provider: 'openrouter',
    baseUrl: 'https://openrouter.ai/api/v1',
    model: 'openai/gpt-5-chat',
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode OpenRouter transform coverage for openai/gpt-5-chat.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode model fixtures and native recorded tests.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode model priority: claude-sonnet-4 is a preferred default-class model.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode small-model priority for cheap/fast tasks.',
  },
  {
    id: 'openrouter-google-gemini-3-pro-preview',
    label: 'OpenRouter · Google Gemini 3 Pro Preview',
    provider: 'openrouter',
    baseUrl: 'https://openrouter.ai/api/v1',
    model: 'google/gemini-3-pro-preview',
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode model priority and fixtures for gemini-3-pro.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode small-model priority for fast responses.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode fixtures for deepseek/deepseek-v4-pro.',
  },
  {
    id: 'openrouter-qwen-plus',
    label: 'OpenRouter · Qwen Plus',
    provider: 'openrouter',
    baseUrl: 'https://openrouter.ai/api/v1',
    model: 'qwen/qwen-plus',
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode fixtures for qwen/qwen-plus.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode model fixtures for Mistral large-family models.',
  },
  {
    id: 'openrouter-groq-llama-3-3-70b',
    label: 'OpenRouter · Groq Llama 3.3 70B Versatile',
    provider: 'openrouter',
    baseUrl: 'https://openrouter.ai/api/v1',
    model: 'groq/llama-3.3-70b-versatile',
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode transform tests for groq/llama-3.3-70b-versatile.',
  },
  {
  ...
  {
    id: 'openmodel-kimi-k2-5-free',
    label: 'OpenModel · Kimi K2.5 Free',
    provider: 'openmodel',
    baseUrl: 'https://api.openmodel.ai/v1',
    model: 'kimi-k2.5-free',
    protocol: 'anthropic-messages',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode opencode-provider/free model naming such as kimi-k2.5-free.',
  },
  {
  ...
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode priority/default model selection.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode small-model priority.',
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode native recorded tests for gpt-4.1-mini.',
  },
  {
  ...
  },
  {
    ...
    protocol: 'anthropic-messages',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode fixtures for claude-sonnet-4-5-20250929.',
  },
  {
    ...
    protocol: 'anthropic-messages',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode small-model priority and recorded tests.',
  },
  {
    id: 'deepseek-chat',
    label: 'DeepSeek · Chat',
  ...
  },
  {
    ...
    protocol: 'openai-chat-completions',
    apiKeyEnv: 'LLM_API_KEY',
    notes: 'Inspired by opencode fixtures for deepseek-v4-pro.',
  },
];
